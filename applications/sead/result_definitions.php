...
(
    ...
    "site_link" =>
		...
		"result_type"=>"link_item",
                "link_url"=>"applications/sead/show_site_details.php?site_id",
    ...
    "link_url"=>"applications/sead/show_details_all_levels.php?level",
		"activated" => true,
		"parents" => array("ROOT"),
		),
      "sample_group_link"	=>
	array(
		...
		"text" => "Full report"	,
		"result_type"=>"link_item",
		"link_url"=>"applications/sead/show_sample_group_details.php?sample_group_id",
		"activated" => true,
		"parents" => array("ROOT")),
