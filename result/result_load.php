...
//		if (!isset($result_params["aggregation_code"]))
//			$result_params["aggregation_code"]="parish_level";
...
echo $xml;
// close the connection after returning the result
pg_close($conn);
